...
La recepción requiere un SDR capaz de sintonizar HF (como un [Airspy HF+ Discovery](/catalog/?type=SDR)) y una antena apropiada para HF. El software utilizado es `dumphfdl`. Una antena de hilo de al menos 10 metros, colocada lo más alto posible, es ideal para comenzar.
