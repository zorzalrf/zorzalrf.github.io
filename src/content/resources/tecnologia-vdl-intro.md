...
La recepción de VDL2 utiliza la misma antena VHF y el mismo hardware [RTL-SDR](/catalog/?type=SDR) que el ACARS tradicional. El decodificador recomendado es `dumpvdl2`, que puede procesar múltiples canales simultáneamente.
