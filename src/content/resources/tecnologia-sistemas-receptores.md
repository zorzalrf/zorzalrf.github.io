...
Si sos nuevo en este pasatiempo, comenzá con **VHF ACARS o VDL2**. Éstos requieren la menor inversión en hardware (un solo [RTL-SDR](/catalog/?type=SDR) y una [antena](/catalog/?type=Antena) VHF básica) y producirán resultados rápidamente si estás cerca de un aeropuerto o ruta de vuelo.
...
El **SATCOM** (Inmarsat AERO e Iridium) requiere hardware mucho más especializado (antenas parabólicas, [LNA](/catalog/?type=Accesorios) de Banda L) y es mejor abordarlo después de tener experiencia con los modos más sencillos.
