...
3. Poné la MicroSD en la Raspberry Pi, conectala al router por cable de red (idealmente), enchufá el [RTL-SDR](/catalog/?type=SDR) (con su [antena](/catalog/?type=Antena)) y encendela.
...
- **[Estación ADS-B Zorzal RF: Receptor V3 + Antena + Filtro](/catalog/?type=SDR)**
- **[Filtro SAW 1090 MHz (ADS-B) - Reduce Interferencia](/catalog/?type=Filtros)**
- **[Antena ADS-B 1090 MHz 5.5dBi - Exterior Profesional](/catalog/?type=Antena)**