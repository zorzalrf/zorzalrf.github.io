...
Si tenés una Raspberry Pi y un [RTL-SDR](/catalog/?type=SDR) (o Airspy), podés conectarlos, ponerlos en una caja estanca en tu terraza y usar un software ligero llamado **SpyServer** (desarrollado por los creadores de SDR#).
