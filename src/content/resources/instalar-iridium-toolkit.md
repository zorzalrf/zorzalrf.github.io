...
*   **SDR**: Cualquier SDR que pueda sintonizar la Banda L de Iridium (1616–1626.5 MHz). SDRs con más ancho de banda capturarán más frecuencias Iridium a la vez. El [RTL-SDR](/catalog/?type=SDR) funciona, pero tiene un ancho limitado de ~2.4 MHz.
*   **[Antena](/catalog/?type=Antena)**: Una antena omnidireccional Banda L con vista despejada al cielo.
*   **[LNA](/catalog/?type=Accesorios)**: Se recomienda encarecidamente un amplificador de bajo ruido (LNA) para el rango de 1.6 GHz (ej. Nooelec SAWbird+ IR).
