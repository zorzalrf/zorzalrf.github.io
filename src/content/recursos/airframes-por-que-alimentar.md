...
**4. Tendrás acceso a la API de Airframes.**
Aún estamos trabajando en ello, pero si sos un contribuyente constante, recibirás un acceso gratuito básico a la API para usar en tus propios proyectos personales. Este es un esfuerzo desafiante que tiene un costo real para mantener el proyecto, pero creemos que al menos deberías poder ver las contribuciones de tus propios datos. Tenemos metas para expandirnos más allá de esto.

**5. Potencialmente ayudarás a prevenir cosas malas en el mundo.**
Los datos de servicios de agregación como [ADSBExchange](https://adsbexchange.com/) han llevado a la captura de terroristas, dictadores y otras personas malintencionadas. No afirmamos que compartir datos garantice esto, pero es reconfortante saber que podrías estar contribuyendo a ello.
