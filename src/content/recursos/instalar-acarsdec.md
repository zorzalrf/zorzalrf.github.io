...
| Opción | Descripción |
| --- | --- |
| `-r <dispositivo> f1 f2 ...` | Número del dispositivo [RTL-SDR](https://zorzalrf.empretienda.com.ar/sdrs/rtl-sdr-blog-v3-receptor-sdr-usb-a-original) seguido de las frecuencias (en MHz) |
