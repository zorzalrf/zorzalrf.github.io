...
Si sos nuevo en este pasatiempo, comenzá con **VHF ACARS o VDL2**. Éstos requieren la menor inversión en hardware (un solo [RTL-SDR](https://zorzalrf.empretienda.com.ar/sdrs/rtl-sdr-blog-v3-receptor-sdr-usb-a-original) y una [antena](https://zorzalrf.empretienda.com.ar/antenas/kit-antena-dipolo-multiproposito-para-sdr-portatil-y-versatil) VHF básica) y producirán resultados rápidamente si estás cerca de un aeropuerto o ruta de vuelo.
...
El **SATCOM** (Inmarsat AERO e Iridium) requiere hardware mucho más especializado (antenas parabólicas, [LNA](https://zorzalrf.empretienda.com.ar/accesorios/lna-amplificador-rtl-sdr-blog-50-4000-mhz-original) de Banda L) y es mejor abordarlo después de tener experiencia con los modos más sencillos.
